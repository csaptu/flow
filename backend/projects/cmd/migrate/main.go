...
func main() {
	...
	cfg, err := config.LoadForService("projects")
	if err != nil {
	...
	if dbURL == "" {
		dbURL = cfg.Databases.Projects.URL
	}
	if dbURL == "" {
		log.Fatal().Msg("No database URL configured. Set DATABASE_URL or PROJECTS_DB_URL")
	}
...
func findMigrationsDir() string {
	candidates := []string{
		...
		"../database/migrations",
		"../../database/migrations",
		"backend/projects/database/migrations",
	}
